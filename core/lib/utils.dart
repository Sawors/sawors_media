...
final defaultDiacriticsRemoval = [
  {
    'base': 'A',
    'letters':
...
String removeDiacritics(String str) {
  ...
  if (diacriticsMap.isEmpty) {
    for (int i = 0; i < defaultDiacriticsRemoval.length; i++) {
      var letters = defaultDiacriticsRemoval[i]['letters']!;
      for (int j = 0; j < letters.length; j++) {
        diacriticsMap[letters[j]] = defaultDiacriticsRemoval[i]['base'];
      }
    }
  }
